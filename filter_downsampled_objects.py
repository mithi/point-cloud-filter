...
pcl.save(downsampled_cloud, 'point_clouds/downsampled_tabletop.pcd')
...
pcl.save(filtered_cloud, 'point_clouds/roi_tabletop.pcd')

# Separate the table from everything else
table_cloud, objects_cloud = do_ransac_plane_segmentation(filtered_cloud, max_distance = 0.01)
pcl.save(table_cloud, 'point_clouds/table_only.pcd');
pcl.save(objects_cloud, 'point_clouds/objects.pcd');
